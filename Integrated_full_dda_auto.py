...
rt_tol = int(rt_tol)
DDA_low_intensity = input("Minimumn required intensity threshold of  DDA MS1 features, example:100 (cps), please input number:")
DDA_low_intensity = int(DDA_low_intensity)
DDA_low_intensity_num = input("Minimum required number of sample in DDA MS1 features, please input number:")
