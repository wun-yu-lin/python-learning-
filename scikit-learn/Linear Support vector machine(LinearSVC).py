# -*- coding: utf-8 -*-
"""
Created on Tue Nov  2 15:38:17 2021
...
for x in range(0,300):
    ...
    predictions = Linear_SVC.predict(dx_test)
    score_training = Linear_SVC.score(dx_train,dy_train)  # 模型對於training data的準確度
    score_testing = Linear_SVC.score(dx_test,dy_test)  # 模型對於testing data的準確度
    # =============================================================================
    # 存取各參數結果
